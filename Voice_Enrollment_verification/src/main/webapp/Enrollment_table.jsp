...
<HTML>
       <HEAD>
       <TITLE>The View Of Enrollment Table </TITLE>
       </HEAD>
       <BODY BGCOLOR="lightblue">
       <H1>The View Of Enrollment Table </H1>
       <%
       ...
       String db_Database ="web_page";
	     ...
	     java.sql.Connection connection = DriverManager.getConnection("jdbc:sqlserver://"+db_Host+":"+db_Port+";user="+db_User+";password="+db_Password+";database="+db_Database);
          ...
          ResultSet resultset = statement.executeQuery("select * from Voice_Details where Status = 'Enrolled'") ;
       %>
      <TABLE BORDER="1">
      <TR>
      <TH>Mobile_number</TH>
